...
function AvailableRooms(props){
    let {_id,roomType,NoOfRooms,cost,image}=props.obj;
    console.log(image);
    ...
    return(
     ...
     <div style={{flexDirection: "column",margin:"20px",width:"250px",height:"400px",borderRadius:"10px",backgroundColor:"#A4193D"}} >
